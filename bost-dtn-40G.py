...
rootdir = "/Users/eashan22/Desktop/Internship 2021/bbrv2/Brian's Project/bost-dtn-40G/"

filterList = [
                "psl01.pic.es",             # 1G host
                "btw-bw.t1.grid.kiae.ru",   # 1G host
                "psb.hpc.utfsm.cl",         # 1G host
                "pygrid-sonar2.lancs.ac.uk" # 100G host
            ]
...
def traverse_non_esnet(path):
    ...
    for root, directories, files in os.walk(path):
        for file in files:
            if file.startswith("ss") and file.endswith("json") and file.find("sacr-pt1")!=-1: # non-esnet host
                print(file)
                fileList.append(os.path.join(root,file))
                c+=1
    print(f"Total files: {c}")
...
paths = [
    ...
    (
        ...
        # All "both"
    (
        # "bost-dtn-40G/2021-07-23:02:12/pscheduler_bbr_both_p16",
        "2021-07-23:02:12/pscheduler_both_p16",
        "2021-07-23:17:46/pscheduler_both_p16",
        "2021-07-23:19:35/pscheduler_both_p16",
        "2021-07-25:14:07/pscheduler_both_p16",
        "2021-07-31:02:27/pscheduler_both_p8",
        "2021-07-31:02:27/pscheduler_both_p16"
    )
]
